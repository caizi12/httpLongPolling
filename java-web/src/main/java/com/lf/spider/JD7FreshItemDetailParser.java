...
//            resultJSONObject.put("dataRootObject", dataRootObject);
            resultJSONObject.put("title", dataObject.getString("skuName"));
            resultJSONObject.put("id", dataObject.getString("skuId"));
            resultJSONObject.put("url", dataObject.getString("item_url"));
            resultJSONObject.put("store_id", dataObject.getString("storeId"));
            resultJSONObject.put("promotion_price", dataObject.getString("jdPrice"));
            resultJSONObject.put("orig_price", dataObject.getString("marketPrice"));
            resultJSONObject.put("sell_num", dataObject.getString("saleNum"));
            resultJSONObject.put("status", dataObject.getString("status"));
            //resultJSONObject.put("promotion_activity", dataObject.getString("saleSpecDesc"));
            resultJSONObject.put("gmt_create",getCurrentTime());
            resultJSONObject.put("source","7fresh");
            resultJSONObject.put("key_property","buy_unit:"+dataObject.getString("buyUnit")+",store_id:"+dataObject.getString("storeId"));
